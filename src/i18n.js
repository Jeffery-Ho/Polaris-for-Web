(() => {
  const messages = Object.freeze({
    en: Object.freeze({
      ...
      "settings.supportedPlatforms": "Supported platforms: ChatGPT, Doubao, Kimi, Qwen, Tencent Yuanbao, and Xiaohongshu Diandian AI.",
      ...
      "history.ready": "Load Makers that have not appeared in this page yet.",
      "history.fetch": "Load history Makers",
      "history.loading": "Loading history · {groups} groups / {makers} Makers added",
      "history.cancel": "Cancel",
      "history.complete": "History synced · {groups} groups / {makers} Makers added",
      "history.partial": "Page history loaded · full ChatGPT branch unavailable",
      "history.partialIndicator": "full ChatGPT branch unavailable",
      "history.timeout": "Loaded {groups} groups / {makers} Makers",
      "history.continue": "Continue",
      "history.rescan": "Scan again",
      "history.retry": "Retry",
      "history.stalled": "The page did not load more history.",
      "history.unavailable": "History loading is unavailable on this page.",
    ...
    zh: Object.freeze({
      ...
      "settings.supportedPlatforms": "支持的平台：ChatGPT、豆包、Kimi、通义千问、腾讯元宝和小红书点点 AI。",
      ...
      "search.empty": "无匹配结果",
      "history.ready": "主动加载尚未进入当前页面的历史 Maker。",
      "history.fetch": "获取历史 Maker",
      "history.loading": "正在获取历史 · 新增 {groups} 组 / {makers} 个 Maker",
      "history.cancel": "取消",
      "history.complete": "历史已同步 · 新增 {groups} 组 / {makers} 个 Maker",
      "history.partial": "已获取当前页面历史 · ChatGPT 完整分支读取失败",
      "history.partialIndicator": "ChatGPT 完整分支读取失败",
      "history.timeout": "已获取 {groups} 组 / {makers} 个 Maker",
      "history.continue": "继续获取",
      "history.rescan": "重新扫描",
      "history.retry": "重试",
      "history.stalled": "页面未继续加载更多历史。",
      "history.unavailable": "当前页面暂时无法获取历史。",
